...
If you want to prioritise a longer stretch of track, place more priority signals farther ahead of the intersection (not too far apart, see the notes). You can chain up to ]] .. constants.maxNChainedPrioritySignalsBeforeIntersection .. [[. If you have a station track closely preceding a priority signal, the whole station track will receive priority as soon as the train starts.
