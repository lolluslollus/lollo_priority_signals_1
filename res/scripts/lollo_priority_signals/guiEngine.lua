...
-- LOLLO TODO this destroys the other priority signals on the same edge as soon as a second priority signal is added:
-- make it destroy all other signals in the edge, with or without priority.
-- signalHelpers.714 will be happy.
